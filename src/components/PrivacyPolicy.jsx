export default function PrivacyPolicy({ standalone }) {
  const content = (
    <>
      {/* Header */}
      ...
      <div className="bg-white rounded-3xl shadow-[0_4px_10px_rgba(0,0,0,0.03)] border border-[#e2eedb] p-6 sm:p-10 text-[#3d4f3a] text-sm sm:text-base leading-relaxed space-y-6">
        ...
        <Section title="1. Informasi Umum">
          <p>
            SSB Palangka Raya United Football Club (&ldquo;kami&rdquo;, &ldquo;kita&rdquo;, atau &ldquo;PR United FC&rdquo;) 
        ...
        <Section title="3. Dasar Hukum Pemrosesan">
          ...
          <ul className="list-disc list-inside space-y-1 text-[#5a6e55]">
            <li><strong>Persetujuan (consent)</strong> &mdash; Anda memberikan persetujuan eksplisit saat mengirimkan formulir pendaftaran</li>
            <li><strong>Kewajiban kontraktual</strong> &mdash; Pemrosesan data diperlukan untuk pelaksanaan pendaftaran dan penyediaan layanan akademi</li>
            <li><strong>Kepentingan hukum</strong> &mdash; Pemenuhan kewajiban peraturan perundang-undangan yang berlaku</li>
          </ul>
        </Section>
        ...
        <Section title="5. Perlindungan Data Anak">
          <p>
            Akademi kami menerima siswa usia 5&ndash;18 tahun. Kami menyadari bahwa anak-anak 
        ...
        <Section title="7. Penyimpanan &amp; Keamanan Data">
          ...
          <ul className="list-disc list-inside space-y-1 text-[#5a6e55]">
            ...
            <li>Penyimpanan di platform terpercaya (Vercel &mdash; lihat <a href="https://vercel.com/security" target="_blank" rel="noopener noreferrer" className="text-orange-accent underline hover:no-underline">keamanan Vercel</a>)</li>
        ...
        <Section title="8. Pengungkapan ke Pihak Ketiga">
          ...
          <ul className="list-disc list-inside space-y-1 text-[#5a6e55]">
            <li>Penyedia layanan teknologi (Vercel &mdash; hosting website) sebatas untuk pengoperasian website</li>
            <li>WhatsApp (Meta) &mdash; untuk pengiriman pesan pendaftaran</li>
            <li>Instansi pemerintah yang berwenang &mdash; jika diwajibkan oleh hukum</li>
          </ul>
        </Section>
        ...
        <Section title="11. Kontak &amp; Pengaduan">
          ...
          <p className="text-xs text-[#7a8f75] mt-2">
            ...
            Jam admin: Senin &mdash; Sabtu, 08.00 &mdash; 17.00 WIB
          </p>
        </Section>
      </div>
