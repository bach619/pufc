export default function CookiePolicy({ standalone }) {
  const content = (
    <>
      {/* Header */}
      ...
      <div className="bg-white rounded-3xl shadow-[0_4px_10px_rgba(0,0,0,0.03)] border border-[#e2eedb] p-6 sm:p-10 text-[#3d4f3a] text-sm sm:text-base leading-relaxed space-y-6">
        ...
        <Section title="5. Dasar Hukum Penggunaan Cookie">
          ...
          <ul className="list-disc list-inside space-y-1 text-[#5a6e55]">
            <li><strong>Kepentingan sah (legitimate interest)</strong> &mdash; untuk cookie teknis yang diperlukan bagi pengoperasian website</li>
            <li><strong>Persetujuan (consent)</strong> &mdash; untuk cookie non-esensial, sesuai dengan Peraturan Menteri Kominfo No. 5 Tahun 2020</li>
          </ul>
          <p className="mt-2">
